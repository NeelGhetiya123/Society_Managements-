                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                            ...
                            <a class="dropdown-item preview-item" href="{{ route('user.bill') }}" style="text-decoration: none;">
                                ...
                                <div class="preview-item-content">
                                    <h6 class="preview-subject font-weight-normal">New Bills</h6>
                            ...
                            <a class="dropdown-item preview-item" href="{{ route('user.announcement') }}" style="text-decoration: none;">
                                <div class="preview-thumbnail">
                                ...
                                <div class="preview-item-content">
                                    <h6 class="preview-subject font-weight-normal">New Announcement</h6>
                                    <p class="font-weight-light small-text mb-0 text-muted">
                                        2 days ago
                                    </p>
                                </div>
                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        @if (isset($loggedAdmin) && $loggedAdmin->picture)
                                <img src="{{ asset('storage/' . $loggedAdmin->picture) }}" alt="Admin Picture">
                            @elseif (isset($LoggedUserInfo) && $LoggedUserInfo->picture)
                                <img src="{{ asset('storage/' . $LoggedUserInfo->picture) }}" alt="User Picture">
                            @else
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('user/bill') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('user/announcement') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('user/complaint') ? 'active' : '' }}"
                            href="{{ route('user.complaint') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('user/user*') ? 'active' : '' }}" data-toggle="collapse" 
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link {{ request()->is('user/login') ? 'active' : ''}}" 
                                href="{{ route('user.login') }}"><h6> Login </h6></a>
                                </li>
                                <li class="nav-item"> <a class="nav-link {{ request()->is('user/register') ? 'active' : ''}}" 
                                href="{{ route('user.register') }}"><h6> Register </h6></a>
                                </li>
                            </ul>
                        </div>
                    </li>
